---
title: "1) General InSiGHTS functions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{1) General InSiGHTS functions}
...
time step. The standard relative change and symmetric relative change are both
returned as fractions; the symmetric relative change is bounded in `[-1, 1]`.
