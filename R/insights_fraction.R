...
#' @name insights_fraction
#' @rdname insights_fraction
#' @aliases insights_fraction,DistributionModel,ANY-method
#' @usage \S4method{insights_fraction}{DistributionModel,ANY}(range,lu,other,outfile,clamp)
methods::setMethod(
  "insights_fraction",
  ...
  function(range, lu, other, outfile = NULL, clamp = FALSE) {
    ...
    if(missing(other)) {
      insights_fraction(range = threshold, lu = lu, outfile = outfile,
                        clamp = clamp)
    } else {
      insights_fraction(range = threshold, lu = lu, other = other,
                        outfile = outfile, clamp = clamp)
    }
  }
)
...
#' @name insights_fraction
#' @rdname insights_fraction
#' @aliases insights_fraction,BiodiversityScenario,ANY-method
#' @usage \S4method{insights_fraction}{BiodiversityScenario,ANY}(range,lu,other,outfile,clamp)
methods::setMethod(
  "insights_fraction",
